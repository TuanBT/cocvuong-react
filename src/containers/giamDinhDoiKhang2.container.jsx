...
class GiamDinhDoiKhang2Container extends Component {
  constructor(props) {
    super(props);
    const me = this;
    this.db = Firebase();
    ...
    this.match;
    this.scoreTimer;
    this.numReferee = 3; //Số lượng Giám định 2 chấm điểm
                  ...
                  <div className="modal-body">
                    <div className="category-buttons">
                      <section className="btn-group refereeChoose">
                        ...
                        <label className="btn btn-outline-secondary" htmlFor="optionsReferee1"> <i className="fa-solid fa-user"></i> <br/>Giám định 2 1 </label>
                        <input type="radio" className="btn-check" name="optionsReferee" id="optionsReferee2" value="2" />
                        <label className="btn btn-outline-secondary" htmlFor="optionsReferee2"> <i className="fa-solid fa-user"></i> <br/>Giám định 2 2 </label>
                        <input type="radio" className="btn-check" name="optionsReferee" id="optionsReferee3" value="3" />
                        <label className="btn btn-outline-secondary" htmlFor="optionsReferee3"> <i className="fa-solid fa-user"></i> <br/>Giám định 2 3 </label>
                        <input type="radio" className="btn-check" name="optionsReferee" id="optionsReferee4" value="4" />
                        <label className="btn btn-outline-secondary" htmlFor="optionsReferee4"> <i className="fa-solid fa-user"></i> <br/>Giám định 2 4 </label>
                        <input type="radio" className="btn-check" name="optionsReferee" id="optionsReferee5" value="5" />
                        <label className="btn btn-outline-secondary" htmlFor="optionsReferee5"> <i className="fa-solid fa-user"></i> <br/>Giám định 2 5 </label> */}
                      </section>
                    </div>
                  </div>
                  <div className="modal-footer">
...
export default GiamDinhDoiKhang2Container;
