...
class TestContainer extends Component {
  ...
  process = () => {
    ...
    //   ['36', '55kg nam', 'Lý Quang Lưu', 'CĐ FPT Poly (CĐ Anh Quốc) (A)'],
    //   ['37', '55kg nam', 'Phạm Mai Nhật Trường', 'Greenwich (Việt Nam) (A)'],
    //   ['38', '55kg nam', 'Trần Minh Phụng', 'CĐ FPT Poly (CĐ Anh Quốc) (A)'],
    //   ['39', '60kg nam', 'Đinh Hoàng Danh ', 'CĐ FPT Poly (CĐ Anh Quốc) (A)'],
    //   ['40', '60kg nam', 'Nguyễn Bảo Phú', 'FPT University (A)'],
    //   ['41', '50kg nữ', 'Nguyễn Thị Hồng Yên', 'CĐ FPT Poly (CĐ Anh Quốc) (A)'],
    //   ['42', '55kg nam', 'Nguyễn Đức Huy', 'FPT University (A)'],
    //   ['43', '60kg nam', 'Đặng Quốc Tuân', 'FPT University (A)'],
    //   ['44', '60kg nam', 'Nguyễn Bình Ca', 'Swinburne (Việt Nam) (A)'],
    ...
    for (let i = 0; i < this.matchs.length; i++) {
      if (this.matchs[i].match !== this.tournamentArray[i].match) {
        // Nơi đổi chỗ đến phải dùng cách tìm cái mach của tour đang là index bao nhiêu của match 
        this.swapRowsName(this.tournamentArray, this.tournamentArray[i].match, this.matchs[i].match)
      }
    }
