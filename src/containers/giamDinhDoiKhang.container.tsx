    ...
    return (
      <div className="fixed inset-0 flex flex-col bg-slate-100 overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-2 gap-2 p-2 min-h-0 relative">
          ...
          {!gdMatch && (
            <div className="absolute inset-0 z-20 grid grid-cols-2 gap-2 p-2 bg-slate-100">
              <div className="flex flex-col gap-2">
                <div className="flex-1 bg-slate-400 rounded-2xl"></div>
                <div className="flex-1 bg-slate-400 rounded-2xl"></div>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex-1 bg-slate-400 rounded-2xl"></div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <label className="relative">
                      ...
                      <div className="p-3 border-2 border-slate-200 rounded-xl text-center peer-checked:border-emerald-500 peer-checked:bg-emerald-50">
                  ...
                  <div className={`grid ${isShowFiveReferee ? 'grid-cols-5' : 'grid-cols-3'} gap-1.5`}>
                    {[1, 2, 3].map((num, i) => (
                      <label key={num} className="relative">
                        ...
                        <div className="p-2 border-2 border-slate-200 rounded-xl text-center peer-checked:border-emerald-500 peer-checked:bg-emerald-50">
