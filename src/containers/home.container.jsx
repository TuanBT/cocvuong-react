          ...
          <div className="container py-3">
            <div className="row row-cols-1 row-cols-md-4 mb-3 text-center">
              ...
              <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm border-success">
                  <div className="card-header py-3 text-bg-success border-success">
                    <h4 className="my-0 fw-normal">GS ĐỐI KHÁNG SÂN B</h4>
                  </div>
                  <div className="card-body">
                    <span className="d-block text-center pb-3 bigIcon"><NavLink to="giam-sat-doi-khang-san-b"><i className="fa-solid fa-tv"></i></NavLink></span>
                  </div>
                </div>
              </div>
              <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm border-success">
                  <div className="card-header py-3 text-bg-success border-success">
                    <h4 className="my-0 fw-normal">GĐ ĐỐI KHÁNG SÂN B</h4>
                  </div>
                  <div className="card-body">
                    <span className="d-block text-center pb-3 bigIcon"><NavLink to="giam-dinh-doi-khang-san-b"><i className="fa-solid fa-table-columns"></i></NavLink></span>
                  </div>
                </div>
              </div>
              <div className="col">
