        ...
        <header className="bg-white/90 backdrop-blur-md shadow-sm border-b border-slate-200 sticky top-0 z-10">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              {tournamentName ? (
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg px-3 py-1.5 max-w-[200px]">
                  <p className="text-xs text-emerald-700 font-medium truncate" title={tournamentName}>
                    {tournamentName}
                  </p>
                </div>
              ) : (
