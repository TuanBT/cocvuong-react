...
class CreateTournamentContainer extends Component {
    constructor(props) {
        ...
        this.combatConst = {
            "combatArena": [{
                ...
                "lastMatch": {"no": 1},
                "referee": [{"blueScore": 0, "redScore": 0}, {"blueScore": 0, "redScore": 0}, {
                    "blueScore": 0,
                    "redScore": 0
                }, {"blueScore": 0, "redScore": 0}, {"blueScore": 0, "redScore": 0}]
            }, {
                "combatArenaName": "Sân B",
                "lastMatch": {"no": 1},
                "referee": [{"blueScore": 0, "redScore": 0}, {"blueScore": 1, "redScore": 0}, {
                    "blueScore": 0,
                    "redScore": 0
                }, {"blueScore": 0, "redScore": 0}, {"blueScore": 0, "redScore": 0}]
            }], "combat": []
    ...
    arrangeCombat = () => {
        ...
        // Sắp xếp các võ sĩ dựa trên số lượng cân nặng và giữ nguyên thứ tự ban đầu trong mỗi hạng cân
        this.combatArrayRaw.sort((a, b) => {
            const weightA = a[1]; // Extract the weight category from the string
            const weightB = b[1]; // Extract the weight category from the string
            const countA = weightCount[weightA];
            ...
            // Sắp xếp theo số lượng cân nặng giảm dần
            if (countB !== countA) {
                return countB - countA;
            }

            // Nếu số lượng cân nặng bằng nhau, sắp xếp theo cân nặng nhỏ hơn
            if (weightA !== weightB) {
                // Move ">" weight category to the end
                if (weightA.includes('>') && !weightB.includes('>')) {
                    return 1;
            ...
            // Nếu số lượng cân nặng bằng nhau, giữ nguyên thứ tự ban đầu
            return this.combatArrayRaw.indexOf(a) - this.combatArrayRaw.indexOf(b);
        });
        ...
        this.matchs.sort((a, b) => {
            const typeOrder = {'Vòng loại-1': 0, 'Vòng loại-2': 1, 'Vòng loại-3': 2, 'Bán Kết': 3, 'Chung Kết': 4};
        ...
        this.matchs.forEach(value => {
            this.combatStandardArray.push([
                value.match, value.weight, value.type.split('-')[0], value.redFighter.name, value.redFighter.code, value.redFighter.country, value.blueFighter.name, value.blueFighter.code, value.blueFighter.country
            ]);
            ...
            matchObjTemp.match.type = value.type.split('-')[0];
                                ...
                                <div className="row flex-nowrap justify-content-between align-items-center">
                                    ...
                                    <div className="col-4 d-flex justify-content-end align-items-center">
                                        <span className="text-muted">
                                            <img src={logo} alt="FPT University - FVC - Bùi Tiến Tuân"
                                                 className="img-fluid"
                                                 style={{width: '38vh'}}/>
                                        </span>
                                    </div>
                            ...
                            <div className="container">
                                ...
                                <div className="tournament-text mb-5 mt-3">
                                    <div className="form-title">
                                        ...
                                        <p className="text-muted"><i>Chức năng cho phép sắp xếp và bốc thăm ngẫu nhiên
                                            dựa vào danh sách
                                            đăng ký.</i></p>
                                    </div>
                                    <div className="function-button">
                                        <div className="input-group">
                                            <a href={mauthodoikhang} download="3-Mau_Tho_Doi_Khang" target="_blank"
                                               rel="noreferrer"
                                               className="btn btn-outline-primary" role="button"><i
                                                className="fa-solid fa-file-download"></i> Download mẫu 3</a>
                                            <input type="file" className="form-control"
                                                   onChange={this.handleimportCombatRawFile}/>
                                            <button className="btn btn-warning" type="button" onClick={this.grouping}><i
                                                className="fas fa-sort-amount-down"></i> Nhóm theo hạng cân
                                            </button>
                                            <button className="btn btn-danger" type="button" onClick={this.shuffle}><i
                                                className="fa-solid fa-shuffle"></i> Xáo trộn & Nhóm hạng cân
                                            </button>
                                            <button className="btn btn-primary" type="button"
                                                    onClick={this.downloadCombatOrigin}><i
                                                className="fa-solid fa-file-download"></i> Download Danh sách
                                            </button>
                                        </div>
                                    </div>
                                    <table>
                                        <thead>
                                        <tr>
                                            {this.combatArrangeHeader && this.combatArrangeHeader.map((header) => <th
                                ...
                                <div className="tournament-text mb-5 mt-3">
                                    <div className="form-title">
                                        ...
                                        <p className="text-muted"><i>Chức năng cho phép tạo một giải đấu đối kháng với
                                            thông tin đầu vào chỉ
                                            bao gồm danh sách vận động viên và hạng cân đã được sắp xếp thứ tự bốc
                                            thăm.</i></p>
                                    </div>
                                    <div className="function-button">
                                        <div className="input-group">
                                            ...
                                            <button className="btn btn-danger" type="button"
                                                    onClick={this.importCombat}><i
                                                className="fa-solid fa-file-import"></i> Khởi tạo Đối Kháng
                                            </button>
                                            <button className="btn btn-primary" type="button"
                                                    onClick={this.downloadCombat}><i
                                                className="fa-solid fa-file-download"></i> Download Danh sách
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="tournament-text mb-5 mt-3">
                                    <div className="form-title">
                                        ...
                                        <p className="text-muted"><i>Chức năng cho phép tạo một giải đấu thi quyền với
                                            thông tin đầu vào chỉ
                                            bao gồm danh sách các vận động viên theo từng nội dung.</i></p>
                                    </div>
                                    <div className="function-button">
                                        <div className="input-group">
                                            <a href={mauthothiquyen} download="4-Mau_Tho_Thi_Quyen" target="_blank"
                                               rel="noreferrer"
                                               className="btn btn-outline-primary" role="button"><i
                                                className="fa-solid fa-file-download"></i> Download mẫu 4</a>
                                            <input type="file" className="form-control"
                                                   onChange={this.handleimportMartialRawFile}/>
                                            <button className="btn btn-danger" type="button"
                                                    onClick={this.importMartial}><i
                                                className="fa-solid fa-file-import"></i> Khởi tạo Thi Quyền
                                            </button>
                                            <button className="btn btn-primary" type="button"
                                                    onClick={this.downloadMartial}><i
                                                className="fa-solid fa-file-download"></i> Download Danh sách
                                            </button>
                                        </div>
                                    </div>
                                    <table>
                                        <thead>
                                        <tr>
                                            {this.martialArrangeHeader && this.martialArrangeHeader.map((header) => <th
                                                key={header}>{header}</th>)}
                                        </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div className="tournament-text mb-5 mt-3">
                                    <div className="form-title">
                                        ...
                                        <p className="text-muted"><i>Chức năng cho phép tạo một giải đấu đối kháng với
                                            thông tin đầu vào đã
                                            được sắp xếp và chuẩn hoá theo từng cặp đấu cố định.</i></p>
                                    </div>
                                    <div className="function-button">
                                        <div className="input-group">
                                            <a href={mauchuandoikhang} download="1-Mau_Chuan_Doi_Khang" target="_blank"
                                               rel="noreferrer"
                                               className="btn btn-outline-primary" role="button"><i
                                                className="fa-solid fa-file-download"></i> Download mẫu 1</a>
                                            <input type="file" className="form-control"
                                                   onChange={this.handleimportCombatStandFile}/>
                                            <button className="btn btn-danger" type="button"
                                                    onClick={this.importCombatStandard}><i
                                                className="fa-solid fa-file-import"></i> Khởi tạo Đối Kháng
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="tournament-text mb-5 mt-3">
                                    <div className="form-title">
                                        ...
                                        <p className="text-muted"><i>Chức năng cho phép tạo một giải đấu thi quyền với
                                            thông tin đầu vào đã
                                            được sắp xếp và chuẩn hoá theo từng trận đấu cố định.</i></p>
                                    </div>
                                    <div className="function-button">
                                        <div className="input-group">
                                            <a href={mauchuanthiquyen} download="2-Mau_Chuan_Thi_Quyen" target="_blank"
                                               rel="noreferrer"
                                               className="btn btn-outline-primary" role="button"><i
                                                className="fa-solid fa-file-download"></i> Download mẫu 2</a>
                                            <input type="file" className="form-control"
                                                   onChange={this.handleimportMartialStandardFile}/>
                                            <button className="btn btn-danger" type="button"
                                                    onClick={this.importMartialStandard}><i
                                                className="fa-solid fa-file-import"></i> Khởi tạo Thi Quyền
                                            </button>
                                        </div>
                                        <table>
                                ...
                                <div className="container">
                                    <footer className="py-3 my-4">
                                        <ul className="nav justify-content-center border-bottom pb-3 mb-3">
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="/">Home</NavLink></li>
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="giam-sat-doi-khang">Giám
                                                sát đối kháng</NavLink></li>
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="giam-dinh-doi-khang">Giám
                                                định đối kháng</NavLink></li>
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="giam-sat-thi-quyen">Giám
                                                sát thi quyền</NavLink></li>
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="giam-dinh-thi-quyen">Giám
                                                định thi quyền</NavLink></li>
                                            <li className="nav-item"><NavLink className="nav-link px-2 text-muted"
                                                                              to="thong-tin-doi-khang">Thông
                                                tin đối kháng</NavLink></li>
                                        </ul>
                            ...
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="modalLabel"><i
                                        className="fa-solid fa-id-badge"></i> Chọn thông tin
                                    </h5>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal"
                                            onClick={this.hideChooseInfoNoModal}></button>
                                </div>
                                ...
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-primary" onClick={this.chooseInfoNo}>OK
                                    </button>
                                    <button type="button" className="btn btn-secondary" data-dismiss="modal"
                                            onClick={this.hideChooseInfoNoModal}>Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
