# Lịch sử tính năng & trao đổi với chủ giải

> Đây là README cũ của dự án, giữ lại nguyên văn làm nhật ký yêu cầu — các câu
> hỏi của chủ giải, câu trả lời, và trạng thái từng tính năng qua các mùa giải.
> Tài liệu giới thiệu dự án nay nằm ở [../README.md](../README.md).
